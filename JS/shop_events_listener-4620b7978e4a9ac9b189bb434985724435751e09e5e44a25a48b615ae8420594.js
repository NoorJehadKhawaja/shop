    ...
    e(function(e, a) {
        ...
        function o(e, t) {
            ...
            e.forEach(function(e, n) {
                ...
                try {
                    ...
                    console && console.warn && console.warn("[shop_events_listener] Error in handleBulkItemCartAddResponse: " + a.message)
                }
                d(e, r)
            })
        }
        ...
        var y, f, h, p = function() {
            ...
            t(e, [{
                ...
                value: function() {
                    this.xhr.readyState === XMLHttpRequest.DONE && e.handleXhrDone({
                        method: this.method,
                        url: this.url,
                        body: this.body,
                        xhr: this.xhr
                ...
                value: function(t) {
                    try {
                        ...
                        console && console.warn && console.warn("[shop_events_listener] Error in handleXhrDone:  " + a.message)
                    }
                }
            }, {
                key: "parseBlobToJson",
        ...
        p.ADD_TO_CART_REGEX = /^(?:\/[a-zA-Z]+(?:\-[a-zA-Z]+)?)?\/cart\/add(?:\.js|\.json)?$/,
        a["default"] = p,
        function() {
            function e(e, t, n) {
                ...
                if (!((e = e || window.event).defaultPrevented || e.isDefaultPrevented && e.isDefaultPrevented())) {
                    ...
                    if (t && (t.getAttribute("action") || t.getAttribute("href")))
                        try {
                            ...
                            window.ShopifyAnalytics.lib.track("monorail://trekkie_storefront_track_added_product/1.1", d)
                        } catch (s) {
                            console && console.warn && console.warn("[shop_events_listener] Error in handleSubmitCartAdd: " + s.message)
                        }
                }
            }
            function n(e) {
                var t = (e = e || window.event).target || e.srcElement;
                if (t && t.getAttribute("action") && null !== t.getAttribute("data-payment-form"))
                    try {
            ...
            function a(e) {
                try {
                    ...
                    if (!(t = n.options && n.options[n.selectedIndex] ? n.options[n.selectedIndex] : n))
                        return;
                    var r = t.value;
                    if (window.ShopifyAnalytics.meta.selectedVariantId && window.ShopifyAnalytics.meta.selectedVariantId == r)
                        return;
                    window.ShopifyAnalytics.meta.selectedVariantId = r;
                    var a = o(r);
                    window.ShopifyAnalytics.lib.track("Viewed Product Variant", a)
                } catch (i) {
                    console && console.warn && console.warn("[shop_events_listener] Error in trackViewedProductVariant: " + i.message)
                }
            }
            function o(e) {
                var t = u(d(e), s());
                return t.currency = window.ShopifyAnalytics.meta.currency,
                t
            }
            function i(e, t) {
                var n = !0
            ...
            function d(e) {
                ...
                if (window.ShopifyAnalytics.meta.products) {
                    ...
                    window.ShopifyAnalytics.meta.product && (n = c(e, t = window.ShopifyAnalytics.meta.product));
                return t ? (r = {
                    productId: t.id,
                    productGid: t.gid,
                    brand: t.vendor,
                    ...
                    try {
                        if (p.ADD_TO_CART_REGEX.test(i)) {
                            try {
                                ...
                                if (Object.keys(c).includes("items"))
                                    return n(t, c),
                                    t
                            } catch (d) {}
                            r(t, e[1].body)
