            ...
            t.cookieImpl = {
                ...
                allowed: function(e) {
                    if (c.isMerchantOnGranularConsentBeta()) {
                        if ([u.shortTermKey, u.longTermKey, u.deprecatedShortTermKey, u.deprecatedLongTermKey].includes(e))
        ...
        2971: function(e, t, n) {
            ...
            t.sendToBugsnag = function(e) {
                ...
                if (this.shouldSendToBugsnag()) {
                    var n = "b31f2032c0d69b240cfbd23a96457e984a0bbbac"
                      , o = null
                      , r = null
                      , i = null;
                    if (e.appConfig)
        ...
        7668: function(e, t, n) {
            ...
            var a = "xxxx-4xxx-xxxx-xxxxxxxxxxxx"
              , s = function() {
                ...
                return e.prototype.fetchOrSet = function(e, t, n, o) {
                    if (!r.enabled())
                    ...
                    a || (a = c(),
                    s = !0,
                    o && !this.isCookieSetServerSideEventFired && (i.logMetricToMonorail("serverSideCookieNotSet_" + n),
              ...
              , C = function() {
                ...
                e.prototype.logAssetContext = function(e) {
                    ...
                    s.addBatchEvent({
                        ...
                        payload: {
                            build_id: "b31f2032c0d69b240cfbd23a96457e984a0bbbac",
                ...
                e.prototype.getS2SEventId = function(e, t) {
                    ...
                    try {
                        if ("product_added_to_cart" === a && (null === (n = window.Shopify) || void 0 === n ? void 0 : n.evids)) {
                            var s = function(e) {
                            ...
                            r = (null === (o = window.Shopify) || void 0 === o ? void 0 : o.evids) && a ? window.Shopify.evids(a, {
                                analyticsFramework: "trekkie"
                            }) : d.buildToken()
                    } catch (e) {
                        r = d.buildToken()
                    ...
                    return {
                        s2sMetadata: i,
                        eventId: "string" == typeof r && r.length > 0 ? r : d.buildToken()
                    }
                }
                ,
