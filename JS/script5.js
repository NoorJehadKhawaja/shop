$(document).ready(function () {
    ...
    $(window).scroll(function () {
        ...
        $(document).on("click", "[data-toggle='collapse']", function () {
            ...
            $(parent).length &&
                ...
                $(this).attr("aria-expanded") == "false"
                    ? ($(target).slideDown().addClass("in"), $(this).removeClass("ishi-collapsed").attr("aria-expanded", "true"))
                    : ($(target).slideUp().removeClass("in"), $(this).addClass("ishi-collapsed").attr("aria-expanded", "false"));
        }),
        ...
        $(document).on("click", function (event) {
            !$(event.target).closest("#search-container-full").length &&
                !$(event.target).closest('[data-href="#search-container-full"]').length &&
                $('[data-href="#search-container-full"]').attr("aria-expanded") == "true" &&
                ($("#search-container-full").removeClass("active"), $('[data-href="#search-container-full"]').attr("aria-expanded", "false")),
                !$(event.target).closest("#user-notification").length &&
                    !$(event.target).closest('[data-href="#user-notification"]').length &&
                    $('[data-href="#user-notification"]').attr("aria-expanded") == "true" &&
                    ($("#user-notification").removeClass("active"), $('[data-href="#user-notification"]').attr("aria-expanded", "false"), event.preventDefault()),
                !$(event.target).closest("#HeaderCountryList").length &&
                    !$(event.target).closest('[data-href="#HeaderCountryList"]').length &&
                    $('[data-href="#HeaderCountryList"]').attr("aria-expanded") == "true" &&
                    ($("#HeaderCountryList").removeClass("active"), $('[data-href="#HeaderCountryList"]').attr("aria-expanded", "false")),
                !$(event.target).closest("#HeaderLanguageList").length &&
                    !$(event.target).closest('[data-href="#HeaderLanguageList"]').length &&
                    $('[data-href="#HeaderLanguageList"]').attr("aria-expanded") == "true" &&
                    ($("#HeaderLanguageList").removeClass("active"), $('[data-href="#HeaderLanguageList"]').attr("aria-expanded", "false"));
        }),
    ...
    $(document).on("click", ".product__media-list .product__media-item", function () {
        ...
        $("#main-media-container").length && window.matchMedia("(min-width: 991px)").matches && $("#main-media-container img").elevateZoom({ zoomType: "inner", cursor: "crosshair" }),
        $(document).on("DOMSubtreeModified", "#main-media-container", function () {
            window.matchMedia("(min-width: 991px)").matches && $(this).find(".product__media-item").data("media-type") != "video" && $("#main-media-container img").elevateZoom({ zoomType: "inner", cursor: "crosshair" });
        }),
        $(".product__media-list").owlCarousel({
            ...
            rtl: rtlFlag,
            rewind: !0,
            responsive: { 0: { items: 3 }, 544: { items: 4 }, 768: { items: 3 }, 992: { items: $("#shopify-section-Ishi_sidebar").length ? 3 : 4 }, 1200: { items: 4 } },
        }),
        ...
        $("#FacetFiltersFormSidebar [type='checkbox']:checked").length && $("#FacetFiltersFormSidebar .clear-all").css("display", "inline-block"),
        $(".owl-carousel.slider-with-options").each(function (index) {
            $(this).owlCarousel({
                ...
                responsive: { 0: { items: $(this).data("small") }, 544: { items: $(this).data("mobile") }, 768: { items: $(this).data("tablet") }, 992: { items: $(this).data("laptop") }, 1200: { items: $(this).data("desktop") } },
            });
        }),
        ...
        $(".write_comment").click(function (e) {
            $(".ishi-product-tab .ishi-nav-tabs a.review-tab").trigger("click"), $("html, body").animate({ scrollTop: $(".ishi-product-tab").offset().top - 50 }, 2e3);
        }),
        adjustFixedHeader(),
        $(window).scroll(function () {
            adjustFixedHeader();
    ...
    shopify_responsive_mobile && convertToMobile(),
        ...
        $("#menu-icon").on("click", function () {
            $("#mobile_top_menu_wrapper").animate({ width: "toggle" }), $(".mobile-menu-overlay").toggleClass("active");
        }),
...
function adjustFixedHeader() {
    ...
    $("#header-layout1").length &&
        (window.matchMedia("(min-width: 992px)").matches &&
            ($(".mobile-width").removeClass("fixed-header"), $(window).scrollTop() > navHeightDesktop ? $(".header-top").addClass("fixed-header") : $(".header-top").removeClass("fixed-header")),
        window.matchMedia("(max-width: 991px)").matches &&
            ($(".header-top").removeClass("fixed-header"), $(window).scrollTop() > navHeightMobile ? $(".mobile-width").addClass("fixed-header") : $(".mobile-width").removeClass("fixed-header"))),
        $("#header-layout2").length &&
            (window.matchMedia("(min-width: 992px)").matches &&
                ($(".mobile-width").removeClass("fixed-header"), $(window).scrollTop() > navfullwidthHeightDesktop ? $(".navfullwidth").addClass("fixed-header") : $(".navfullwidth").removeClass("fixed-header")),
            window.matchMedia("(max-width: 991px)").matches &&
                ($(".navfullwidth").removeClass("fixed-header"), $(window).scrollTop() > navHeightMobile ? $(".mobile-width").addClass("fixed-header") : $(".mobile-width").removeClass("fixed-header")));
}
$(function () {
                ...
                $('<ul class="search-results"></ul>').css({ position: "absolute", left: "0px", top: offSet }).appendTo($(this)).hide(),
                    input.attr("autocomplete", "off").bind("keyup change", function () {
                        ...
                        term.length > 3 &&
                            ...
                            currentAjaxRequest != null && currentAjaxRequest.abort(),
                                ...
                                resultsList.empty(),
                                    data.results_count == 0
                                        ...
                                        : ($.each(data.results, function (index, item) {
                                          ...
                                          data.results_count > 10 && resultsList.append('<li><span class="title"><a href="' + searchURL + '">See all results (' + data.results_count + ")</a></span></li>"),
    ...
    (variantAvailability = []),
        ...
        jQuery.getJSON("/products/" + handle + ".js", function (product) {
            $("#qv-productname").html(product.title),
                ...
                product.description.length < 300 ? $(".more-description").css("display", "none") : $(".more-description").css("display", "block"),
                $("#qv-product-cover img").attr("src", product.featured_image);
            var reviews = $('[data-handle="' + handle + '"]')
            ...
            if (($("#qv-spr-badge").html(reviews.html()), prepareQvThumbnails(product.images), product.variants.length > 1)) {
                ...
                (colorNameList = colorNameList.split(",")),
                    $(product.options).each(function (i, option) {
                        ...
                        swatchWrapper.append('<div class="option-label"><label>' + name + "</label></div>"),
                            $(option.values).each(function (i2, value) {
                                ...
                                if (includesColor) {
                                    var dummyImg = "//cdn.shopify.com/s/files/1/0433/3790/8380/files/dummy?45575",
                                    ...
                                    optionValues.append('<label style="' + imgURL + '" for="' + name + "-" + i2 + '" class="' + className + '" data-index="' + i2 + '"></label>');
                    ...
                    $(product.variants).each(function (index, variant2) {
                        ...
                        variantIndexIdMapping.push(variant2.id),
                            availableVariants.push(variantsKeyVal),
                            variantAvailability.push(variant2.available),
                            variantFeaturedImg.push(variant2.featured_image.src),
                            variantCompareAtPrice.push(variant2.compare_at_price),
                            variantPrice.push(variant2.price);
                    }),
                ...
                $("#qv-variantid").val(variant.id),
                    variant.available ? $("#qv-add-to-cart").removeClass("sold-out") : $("#qv-add-to-cart").addClass("sold-out"),
                    variant.compare_at_price != null && variant.compare_at_price > variant.price
                        ? ($("#qv-compareatprice").html(convertToMoney(variant.compare_at_price)), $("#qv-price").html(convertToMoney(variant.price)))
                        : ($("#qv-compareatprice").html(""), $("#qv-price").html(convertToMoney(variant.price)));
            }
...
function prepareQvThumbnails(images) {
    ...
    $(images).each(function (i, src) {
        ...
        thumbnailSliderWrapper.owlCarousel({
            ...
            rtl: rtlFlag,
            rewind: !0,
            responsive: { 0: { items: 3 }, 544: { items: 4 }, 768: { items: 3 }, 992: { items: 4 }, 1200: { items: 4 } },
        });
}
...
function updateQvVariantDetails() {
    ...
    $("#qv-variantid").val(variantIndexIdMapping[index]), available ? $("#qv-add-to-cart").removeClass("sold-out") : $("#qv-add-to-cart").addClass("sold-out"), $("#qv-product-cover img").attr("src", variantFeaturedImg[index]);
    var price = variantPrice[index],
        compare_at_price = variantCompareAtPrice[index];
    compare_at_price != null && compare_at_price > price
        ? ($("#qv-compareatprice").html(convertToMoney(compare_at_price)), $("#qv-price").html(convertToMoney(price)))
        : ($("#qv-compareatprice").html(""), $("#qv-price").html(convertToMoney(price)));
}
...
//# sourceMappingURL=/cdn/shop/t/28/assets/shop.js.map?v=126999597284576877841689854634
